...
Feature: Deduplicate Ipni
    ...
    Scenario: Genus level
        Given Rachel has created an input-file to feed the deduplicator containing tab-separated Genus data
            ...
            | 1001-3     | Ericaceae   | Lëucothoe       | D.Don       |                 | D.Don             | Lëucothoe                            | Edinburgh New Philos. J. | 17: 158       | 1834             |                   |         | 9         | Does presence of diacritic character in middle of name prevent clustering                         |
            | 1001-4     | Ericaceae   | Lëucothoe       | D.Don       |                 | D.Don             | Lëucothoe                            | Edinburgh New Philos. J. | 17: 158       | 1834             |                   |         | 9         | Does presence of diacritic character in middle of name prevent clustering                         |
        ...
        And Alecs has set up a genus-dedup configuration file:
            ...
            <beans xmlns="http://www.springframework.org/schema/beans"
                ...
                <bean id="authorCommonTokensMatcher" class="org.kew.rmf.matchers.AuthorCommonTokensMatcher"
                    p:minRatio="0.6"/>
                <bean id="capitalLettersMatcher" class="org.kew.rmf.matchers.CapitalLettersMatcher"
                    p:minRatio="0.5"/>
                <bean id="numberMatcher" class="org.kew.rmf.matchers.NumberMatcher"
                    p:minRatio="0.5"/>
                ...
                <util:list id="reporters">
                    ...
                    <bean class="org.kew.rmf.reporters.DedupReporterMultiline"
                        p:name="dedupReporterMultiline"
                        p:configName="thisConfig"
                        p:delimiter="&#09;"
                        p:idDelimiter="|">
                        <property name="file">
                            <bean class="java.io.File">
                                <constructor-arg value="REPLACE_WITH_TMPDIR/output_multiline.txt" />
                            </bean>
                        </property>
                    </bean>
                </util:list>
        ...
        Then a file should have been created in the same folder with the following data:
            ...
            | 1001-1     | Ericaceae   | Leucothoë       | Leucothoe       | D.Don                  | D Don                    | Leucothoë                            | Edinburgh New Philos J   | 17: 159        | 17 159           | 1834             | 9         | Does presence of diacritic character at end of name prevent clustering                            | 4            | 1001-1     | 1001-1 \| 1001-2 \| 1001-3 \| 1001-4 |
            | 28674-1    | Orchidaceae | Amphorchis      | Amphorchis      | Thouars                | Thouars                  | Amphorchis                           | Hist Orchid              | Tabl. Synopt.  | Tabl Synopt      | 1822             | 8         | Does absence of numerical characters in genus name prevent clustering                             | 2            | 28675-1    | 28674-1 \| 28675-1                   |
        ...
        And a file for the multiline output should have been created in the same folder with the following data:
            ...
            | 9999-1     | Rapateaceae | Saxo-fridericia |  Saxo fridericia | R.H.Schomb.       | R H Schomb               | Saxo-fridericia                      | Rapatea                | 13            | 13               | 1845             | 7         | Does presence of hyphen in genus name prevent clustering                                          | 3            | 30022170-2     | 3    |
            | 1001-1     | Ericaceae   | Leucothoë       |  Leucothoe       | D.Don             | D Don                    | Leucothoë                            | Edinburgh New Philos J | 17: 159       | 17 159           | 1834             | 9         | Does presence of diacritic character at end of name prevent clustering                            | 4            | 1001-1         | 1    |
            | 1001-2     | Ericaceae   | Leucothoë       |  Leucothoe       | D.Don             | D Don                    | Leucothoë                            | Edinburgh New Philos J | 17: 159       | 17 159           | 1834             | 9         | Does presence of diacritic character at end of name prevent clustering                            | 4            | 1001-1         | 2    |
            | 1001-3     | Ericaceae   | Lëucothoe       |  Leucothoe       | D.Don             | D Don                    | Lëucothoe                            | Edinburgh New Philos J | 17: 158       | 17 158           | 1834             | 9         | Does presence of diacritic character in middle of name prevent clustering                         | 4            | 1001-1         | 3    |
            | 1001-4     | Ericaceae   | Lëucothoe       |  Leucothoe       | D.Don             | D Don                    | Lëucothoe                            | Edinburgh New Philos J | 17: 158       | 17 158           | 1834             | 9         | Does presence of diacritic character in middle of name prevent clustering                         | 4            | 1001-1         | 4    |
            | 28674-1    | Orchidaceae | Amphorchis      |  Amphorchis      | Thouars           | Thouars                  | Amphorchis                           | Hist Orchid            | Tabl. Synopt. | Tabl Synopt      | 1822             | 8         | Does absence of numerical characters in genus name prevent clustering                             | 2            | 28674-1        | 1    |
            | 28675-1    | Orchidaceae | Amphorchis      |  Amphorchis      | Thouars           | Thouars                  | Amphorchis                           | Hist Orchid            | Tabl. Synopt. | Tabl Synopt      | 1822             | 7         | Does absence of numerical characters in genus name prevent clustering                             | 2            | 28674-1        | 2    |
            | 6001-1     | Ericaceae   | Leucothoe       |  Leucothoe       | D.Dön             | D Don                    | Leucothoe                            | Edinburgh New Philos J | 16: 158       | 16 158           | 1834             | 9         | Does presence of diacritic character in middle of author prevent clustering                       | 2            | 6001-1         | 1    |
            | 6001-2     | Ericaceae   | Leucothoe       |  Leucothoe       | D.Dön             | D Don                    | Leucothoe                            | Edinburgh New Philos J | 16: 158       | 16 158           | 1834             | 9         | Does presence of diacritic character in middle of author prevent clustering                       | 2            | 6001-1         | 2    |
            | 7001-1     | Ericaceae   | Leucothoe       |  Leucothoe       | D.Donë            | D Done                   | Leucothoe                            | Edinburgh New Philos J | 15: 158       | 15 158           | 1834             | 9         | Does presence of diacritic character at end of author prevent clustering                          | 2            | 7001-1         | 1    |
            | 7001-2     | Ericaceae   | Leucothoe       |  Leucothoe       | D.Donë            | D Done                   | Leucothoe                            | Edinburgh New Philos J | 15: 158       | 15 158           | 1834             | 9         | Does presence of diacritic character at end of author prevent clustering                          | 2            | 7001-1         | 2    |
            | 3001-1     | Orchidaceae | × Amphorchis    |  Amphorchis      | Thouars           | Thouars                  | × Amphorchis                         | Hist Orchid            | 211           | 211              | 1822             | 8         | Does presence of multiplication sign and whitespace at start of genus name prevent clustering     | 2            | 3001-1         | 1    |
            | 3001-2     | Orchidaceae | × Amphorchis    |  Amphorchis      | Thouars           | Thouars                  | × Amphorchis                         | Hist Orchid            | 211           | 211              | 1822             | 8         | Does presence of multiplication sign and whitespace at start of genus name prevent clustering     | 2            | 3001-1         | 2    |
            | 4001-1     | Orchidaceae | ×Amphorchis     |  Amphorchis      | Thouars           | Thouars                  | ×Amphorchis                          | Hist Orchid            | 56            | 56               | 1822             | 8         | Does presence of multiplication sign without whitespace at start of genus name prevent clustering | 2            | 4001-1         | 1    |
            | 4001-2     | Orchidaceae | ×Amphorchis     |  Amphorchis      | Thouars           | Thouars                  | ×Amphorchis                          | Hist Orchid            | 56            | 56               | 1822             | 8         | Does presence of multiplication sign without whitespace at start of genus name prevent clustering | 2            | 4001-1         | 2    |
            | 5001-1     | Orchidaceae | X Amphorchis    |  Amphorchis      | Thouars           | Thouars                  | X Amphorchis                         | Hist Orchid            | 11            | 11               | 1822             | 8         | Does presence of capital letter X at start of name prevent clustering                             | 2            | 5001-1         | 1    |
            | 5001-2     | Orchidaceae | X Amphorchis    |  Amphorchis      | Thouars           | Thouars                  | X Amphorchis                         | Hist Orchid            | 11            | 11               | 1822             | 8         | Does presence of capital letter X at start of name prevent clustering                             | 2            | 5001-1         | 2    |
    ...
    Scenario: Species level
        ...
        Then a file should have been created in the same folder with the following data:
            ...
            | 17291860-1 | Dryopteridaceae |  Dryopteris |   Dryopteris |                             C Chr |                         C Chr |          Dryopteris filix mas x spinulosa |       Dryopteris filix mas spinulosa        |                                |                      |                  |                  |                   |                     |         3 | Dryopteridaceae |            2 | 17291860-1 |                 17291860-1 \| 17270100-1 |
