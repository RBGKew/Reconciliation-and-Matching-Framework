...
import org.kew.stringmod.matchconf.web.ApplicationConversionServiceFactoryBean;
...
privileged aspect ApplicationConversionServiceFactoryBean_Roo_ConversionService {
    ...
    public Converter<Long, Configuration> ApplicationConversionServiceFactoryBean.getIdToConfigurationConverter() {
        return new org.springframework.core.convert.converter.Converter<java.lang.Long, org.kew.stringmod.matchconf.Configuration>() {
            public org.kew.stringmod.matchconf.Configuration convert(java.lang.Long id) {
    ...
    public Converter<String, Configuration> ApplicationConversionServiceFactoryBean.getStringToConfigurationConverter() {
        return new org.springframework.core.convert.converter.Converter<java.lang.String, org.kew.stringmod.matchconf.Configuration>() {
            public org.kew.stringmod.matchconf.Configuration convert(String id) {
    ...
    public Converter<Matcher, String> ApplicationConversionServiceFactoryBean.getMatcherToStringConverter() {
        return new org.springframework.core.convert.converter.Converter<org.kew.stringmod.matchconf.Matcher, java.lang.String>() {
    ...
    public Converter<Long, Matcher> ApplicationConversionServiceFactoryBean.getIdToMatcherConverter() {
        return new org.springframework.core.convert.converter.Converter<java.lang.Long, org.kew.stringmod.matchconf.Matcher>() {
            public org.kew.stringmod.matchconf.Matcher convert(java.lang.Long id) {
    ...
    public Converter<String, Matcher> ApplicationConversionServiceFactoryBean.getStringToMatcherConverter() {
        return new org.springframework.core.convert.converter.Converter<java.lang.String, org.kew.stringmod.matchconf.Matcher>() {
            public org.kew.stringmod.matchconf.Matcher convert(String id) {
    ...
    public Converter<Reporter, String> ApplicationConversionServiceFactoryBean.getReporterToStringConverter() {
        return new org.springframework.core.convert.converter.Converter<org.kew.stringmod.matchconf.Reporter, java.lang.String>() {
    ...
    public Converter<Long, Reporter> ApplicationConversionServiceFactoryBean.getIdToReporterConverter() {
        return new org.springframework.core.convert.converter.Converter<java.lang.Long, org.kew.stringmod.matchconf.Reporter>() {
            public org.kew.stringmod.matchconf.Reporter convert(java.lang.Long id) {
    ...
    public Converter<String, Reporter> ApplicationConversionServiceFactoryBean.getStringToReporterConverter() {
        return new org.springframework.core.convert.converter.Converter<java.lang.String, org.kew.stringmod.matchconf.Reporter>() {
            public org.kew.stringmod.matchconf.Reporter convert(String id) {
    ...
    public Converter<Transformer, String> ApplicationConversionServiceFactoryBean.getTransformerToStringConverter() {
        return new org.springframework.core.convert.converter.Converter<org.kew.stringmod.matchconf.Transformer, java.lang.String>() {
    ...
    public Converter<Long, Transformer> ApplicationConversionServiceFactoryBean.getIdToTransformerConverter() {
        return new org.springframework.core.convert.converter.Converter<java.lang.Long, org.kew.stringmod.matchconf.Transformer>() {
            public org.kew.stringmod.matchconf.Transformer convert(java.lang.Long id) {
    ...
    public Converter<String, Transformer> ApplicationConversionServiceFactoryBean.getStringToTransformerConverter() {
        return new org.springframework.core.convert.converter.Converter<java.lang.String, org.kew.stringmod.matchconf.Transformer>() {
            public org.kew.stringmod.matchconf.Transformer convert(String id) {
    ...
    public Converter<Long, Wire> ApplicationConversionServiceFactoryBean.getIdToWireConverter() {
        return new org.springframework.core.convert.converter.Converter<java.lang.Long, org.kew.stringmod.matchconf.Wire>() {
            public org.kew.stringmod.matchconf.Wire convert(java.lang.Long id) {
    ...
    public Converter<String, Wire> ApplicationConversionServiceFactoryBean.getStringToWireConverter() {
        return new org.springframework.core.convert.converter.Converter<java.lang.String, org.kew.stringmod.matchconf.Wire>() {
            public org.kew.stringmod.matchconf.Wire convert(String id) {
    ...
    public Converter<WiredTransformer, String> ApplicationConversionServiceFactoryBean.getWiredTransformerToStringConverter() {
        return new org.springframework.core.convert.converter.Converter<org.kew.stringmod.matchconf.WiredTransformer, java.lang.String>() {
    ...
    public Converter<Long, WiredTransformer> ApplicationConversionServiceFactoryBean.getIdToWiredTransformerConverter() {
        return new org.springframework.core.convert.converter.Converter<java.lang.Long, org.kew.stringmod.matchconf.WiredTransformer>() {
            public org.kew.stringmod.matchconf.WiredTransformer convert(java.lang.Long id) {
    ...
    public Converter<String, WiredTransformer> ApplicationConversionServiceFactoryBean.getStringToWiredTransformerConverter() {
        return new org.springframework.core.convert.converter.Converter<java.lang.String, org.kew.stringmod.matchconf.WiredTransformer>() {
            public org.kew.stringmod.matchconf.WiredTransformer convert(String id) {
